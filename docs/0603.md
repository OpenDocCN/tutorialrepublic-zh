...
> 原文:[https://www . tutorial Republic . com/CSS-reference/CSS-border-bottom-property . PHP](https://www.tutorialrepublic.com/css-reference/css-border-bottom-property.php)
