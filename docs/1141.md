...
> 原文:[https://www . tutorial Republic . com/Twitter-bootstrap-4-tutorial/bootstrap-dropdowns . PHP](https://www.tutorialrepublic.com/twitter-bootstrap-4-tutorial/bootstrap-dropdowns.php)
...
上面的例子演示了最基本的引导下拉形式。让我们逐一了解 Bootstrap dropdown 组件的各个部分。
...
类似地，您可以向按钮和导航组件添加下拉菜单。下一节将向您展示引导下拉菜单的一些常见实现。
...
[![Bootstrap Dropdowns within Navbar](../Images/50f8920e0fba4e10c917d9b1e2e5b9fd.png)](../codelab.php?topic=bootstrap-4&file=dropdowns-within-navbar)  ***提示:**您可以通过在空白的`<div>`元素上添加类`.dropdown-divider`来绘制分隔线来分隔下拉菜单中的链接。*  ** * *
...
[![Bootstrap Dropdowns within Nav](../Images/16923fee48a54c7522f5621d60d2ae04.png)](../codelab.php?topic=bootstrap-4&file=dropdowns-within-nav) 
...
[![Bootstrap Dropdowns within Buttons](../Images/6f7d8372d904b106b18f2f8bf9df63a1.png)](../codelab.php?topic=bootstrap-4&file=dropdowns-within-buttons) 
...
[![Bootstrap Split Button Dropdowns](../Images/3cc386588be9b4974fb50bae6901f380.png)](../codelab.php?topic=bootstrap-4&file=split-button-dropdowns)  ***提示:**你可以在`.btn`元素上使用 Bootstrap 的按钮相对大小调整类，比如`.btn-lg`和`.btn-sm`来进一步[调整按钮下拉列表](../codelab.php?topic=bootstrap-4&file=sizing-button-dropdowns)的大小。*  ** * *

## 按钮组内的下拉列表

要在按钮组中创建下拉菜单，只需在另一个`.btn-group`中放置一个`.btn-group`和下拉标记。
...
[![Bootstrap Dropdowns within Button Groups](../Images/0810c02c1ec0cd48e769448da66cb03c.png)](../codelab.php?topic=bootstrap-4&file=dropdowns-within-button-groups) 
...
[![Bootstrap Dropup Menus](../Images/61fd28616ae864686d32410979b30538.png)](../codelab.php?topic=bootstrap-4&file=dropup-dropleft-and-dropright-menus) 
...
[![Bootstrap Right-aligned Dropdown Menus](../Images/c9fa523cb5784acd0e2af844f4e55b2a.png)](../codelab.php?topic=bootstrap-4&file=right-aligned-dropdown-menus) 

* * *

## 向下拉项目添加标题

通过将类`.dropdown-header`添加到`<div>`元素中，可以选择添加一个菜单标题来标记下拉菜单中的菜单项，如下所示:
...
这些是增强下拉菜单功能的标准引导事件。所有 dropdown 事件都在`.dropdown-menu`的父元素上触发。
