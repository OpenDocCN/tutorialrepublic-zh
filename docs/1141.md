...
[Try this code »](../codelab.php?topic=bootstrap-4&file=dropdowns-within-navbar "Try this code using online Editor") *```html
...
[Try this code »](../codelab.php?topic=bootstrap-4&file=dropdowns-within-nav "Try this code using online Editor") *```html
...
[Try this code »](../codelab.php?topic=bootstrap-4&file=dropup-dropleft-and-dropright-menus "Try this code using online Editor") *```html
<!-- Dropup menu -->
