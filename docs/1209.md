...
Procedural Object Oriented PDO[Download](../examples/bin/download-source.php?topic=php&file=register "Download Source Code") *```php
<?php
// Include config file
...
Procedural Object Oriented PDO[Download](../examples/bin/download-source.php?topic=php&file=login "Download Source Code") *```php
<?php
...
[Download](../examples/bin/download-source.php?topic=php&file=welcome "Download Source Code") *```php
<?php
// Initialize the session
session_start();
...
Procedural Object Oriented PDO[Download](../examples/bin/download-source.php?topic=php&file=reset-password "Download Source Code") *```php
<?php
// Initialize the session
session_start();
