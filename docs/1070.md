...
[Try this code »](../codelab.php?topic=bootstrap&file=simple-table "Try this code using online Editor") *```html
<table class="table">
    <thead>
        <tr>
            <th>#</th>
...
[Try this code »](../codelab.php?topic=bootstrap&file=dark-table "Try this code using online Editor") *```html
...
[Try this code »](../codelab.php?topic=bootstrap&file=accented-table "Try this code using online Editor") *```html
...
[Try this code »](../codelab.php?topic=bootstrap&file=table-with-accented-rows "Try this code using online Editor") *```html
<table class="table">
    <thead>
        <tr>
            <th>#</th>
...
[Try this code »](../codelab.php?topic=bootstrap&file=table-striped "Try this code using online Editor") *```html
...
[Try this code »](../codelab.php?topic=bootstrap&file=table-bordered "Try this code using online Editor") *```html
...
[Try this code »](../codelab.php?topic=bootstrap&file=borderless-table "Try this code using online Editor") *```html
...
[Try this code »](../codelab.php?topic=bootstrap&file=table-with-hover-states "Try this code using online Editor") *```html
...
[Try this code »](../codelab.php?topic=bootstrap&file=compact-table "Try this code using online Editor") *```html
...
[Try this code »](../codelab.php?topic=bootstrap&file=table-head-light "Try this code using online Editor") *```html
<table class="table">
...
[Try this code »](../codelab.php?topic=bootstrap&file=table-head-dark "Try this code using online Editor") *```html
<table class="table">
...
[Try this code »](../codelab.php?topic=bootstrap&file=responsive-table "Try this code using online Editor") *```html
