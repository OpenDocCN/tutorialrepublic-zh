...
> 原文:[https://www . tutorial Republic . com/Twitter-bootstrap-tutorial/bootstrap-collapse . PHP](https://www.tutorialrepublic.com/twitter-bootstrap-tutorial/bootstrap-collapse.php)
...
要使可折叠控件像手风琴菜单一样成组工作，您可以利用[引导卡](bootstrap-cards.php)组件。参见[自举手风琴](bootstrap-accordion.php)教程了解更多信息。
