...
[Try this code »](../codelab.php?topic=bootstrap-4&file=large-and-small-modal-sizes "Try this code using online Editor") *```html
<!-- Extra Large modal -->
...
[Try this code »](../codelab.php?topic=bootstrap-4&file=vertically-centering-the-modal "Try this code using online Editor") *```html
<!-- Button HTML (to Trigger Modal) -->
...
[Try this code »](../codelab.php?topic=bootstrap-4&file=creating-row-columns-inside-modal "Try this code using online Editor") *```html
