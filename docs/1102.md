...
> 原文:[https://www . tutorial Republic . com/Twitter-bootstrap-tutorial/bootstrap-type ahead . PHP](https://www.tutorialrepublic.com/twitter-bootstrap-tutorial/bootstrap-typeahead.php)
...
[![Twitter Typeahead](../Images/16235655e6629a7ed86610655b7ab739.png)](../codelab.php?topic=bootstrap&file=typeahead-with-local-dataset)  ***注意:** Bloodhound 是`typeahead.js`建议引擎。它非常灵活，并提供高级功能，如预取远程数据、使用浏览器[本地存储](../html-tutorial/html5-web-storage.php)通过智能缓存进行快速查找等。*  ****提示:**如果你想防止默认的浏览器菜单出现在引导式预输入下拉菜单上，为输入框设置`autocomplete="off"`。*  ** * *
