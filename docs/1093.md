...
[![Bootstrap Modal Popup](img/fb1fe222bbd7e4dc7f30fa7ba6989fb6.png)](../codelab.php?topic=bootstrap&file=modal)  ***提示:**总是试图将你的模态 HTML 放在文档的顶层位置，最好是在`[<body>](../html-reference/html-body-tag.php)`标签(即`</body>`)结束之前，以避免其他元素的干扰，否则可能会影响模态的外观或功能。*  *查看 snippets 部分，获得一些设计精美的Bootstrap模式的例子。
