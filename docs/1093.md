...
[Try this code »](../codelab.php?topic=bootstrap&file=large-and-small-modal-sizes "Try this code using online Editor") *```html
<!-- Extra Large modal -->
...
[Try this code »](../codelab.php?topic=bootstrap&file=vertically-centering-the-modal "Try this code using online Editor") *```html
<!-- Button HTML (to Trigger Modal) -->
...
[Try this code »](../codelab.php?topic=bootstrap&file=creating-row-columns-inside-modal "Try this code using online Editor") *```html
<div id="myModal" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
