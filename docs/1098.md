...
> 原文:[https://www . tutorial Republic . com/Twitter-bootstrap-tutorial/bootstrap-popovers . PHP](https://www.tutorialrepublic.com/twitter-bootstrap-tutorial/bootstrap-popovers.php)
...
[![Bootstrap Popover](../Images/529110203be6b1f597062bc083a5fd9c.png)](../codelab.php?topic=bootstrap&file=enable-popovers-via-jquery) 
...
| 超文本标记语言 | 布尔型 | 错误的 | 将 HTML 插入弹出窗口。如果使用`false`，`innerText`属性将内容插入到 DOM 中。如果你担心 XSS 的袭击，就用简单的文字。 |
