...
> 原文：<https://www.tutorialrepublic.com/twitter-bootstrap-tutorial/bootstrap-helper-classes.php>
 ...
 ***提示:**`.float-*-left`和`.float-*-right`类中的`*`字符代表响应断点，可以是`sm`、`md`、`lg`、`xl`或`xxl`。详见[Bootstrap 网格系统](bootstrap-grid-system.php)。*  ** * *
...
您也可以使用响应断点(`sm`、`md`、`lg`、`xl`和 xxl)。)使用这些显示实用程序类，使用格式`.d-{breakpoint}-{value}`根据视窗宽度显示或隐藏元素，例如`.d-sm-none`、`.d-md-block`、`.d-lg-block`、`.d-xl-block`、`.d-xxl-block`等等。
