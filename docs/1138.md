...
> 原文：<https://www.tutorialrepublic.com/twitter-bootstrap-4-tutorial/bootstrap-helper-classes.php>

在本教程中，您将了解 Bootstrap 助手/实用程序类。
 ...
 ***提示:**`.float-*-left`和`.float-*-right`类中的`*`字符代表响应断点，可以是`sm`、`md`、`lg`或`xl`。详见[Bootstrap 网格系统](bootstrap-grid-system.php)。*  ** * *
...
您可以使用垂直对齐实用程序类来快速更改内联、内联块、内联表格和表单元格元素的垂直对齐。
