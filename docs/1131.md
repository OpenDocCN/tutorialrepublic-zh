...
[![Bootstrap Navbar with Dropdown and Search Form](img/0ca7085c471bdcd7c1d4a6e5e7a4b1eb.png)](../codelab.php?topic=bootstrap-4&file=static-navbar-with-dropdown-and-search-form)  ***提示:**要创建不固定在顶部或底部的导航条，可以把它放在`.container`中的任何地方，它设置了你的站点和内容的宽度。*  *查看 snippets 部分，查看一些设计精美的Bootstrap导航条的例子。
