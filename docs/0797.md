...
> 原文:[https://www . tutorial Republic . com/CSS-reference/css3-border-radius-property . PHP # property-values](https://www.tutorialrepublic.com/css-reference/css3-border-radius-property.php#property-values)
