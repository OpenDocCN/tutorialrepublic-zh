...
> 原文:[https://www . tutorial Republic . com/Twitter-bootstrap-tutorial/bootstrap-stateful-buttons . PHP](https://www.tutorialrepublic.com/twitter-bootstrap-tutorial/bootstrap-stateful-buttons.php)
...
[![Bootstrap Single Toggle Button](../Images/e54ee7c3396c1572294ede417f522cec.png)](../codelab.php?topic=bootstrap&file=single-toggle-button)  ***注意:**Mozilla Firefox 浏览器跨页面加载保持按钮状态，为了防止这种行为，您可以简单地在包含按钮的表单上设置属性`autocomplete="off"`，或者直接设置输入或按钮元素的属性。*  ** * *
...
[![Bootstrap Checkbox Button Groups](../Images/1452e86718ac898270a7794c40568ed1.png)](../codelab.php?topic=bootstrap&file=checkbox-button-groups)  ***注意:**不要使用`.active`类来预选按钮组中的复选框或单选按钮，因为它只会改变视觉外观，使它们看起来像被选中了一样。要实际预选它们，您需要自己在输入元素上应用`checked`属性。*  ** * *
...
[![Bootstrap Radio Button Groups](../Images/a4494afacd557315dacc01074e1cdce3.png)](../codelab.php?topic=bootstrap&file=radio-button-groups) 
