...
> 原文:[https://www . tutorial Republic . com/Twitter-bootstrap-4-tutorial/bootstrap-media-objects . PHP](https://www.tutorialrepublic.com/twitter-bootstrap-4-tutorial/bootstrap-media-objects.php)

在本教程中，您将学习如何使用引导媒体对象组件。

## 使用引导媒体对象

如果您想要创建一个布局，其中包含左对齐或右对齐的媒体对象(如图像或视频)以及文本内容(如博客评论、推文等)。您可以使用新引入的引导媒体组件轻松实现这一点，如下所示:
...
[![Bootstrap Media Objects](../Images/76625171e8755b45cc6547c532c0fe08.png)](../codelab.php?topic=bootstrap-4&file=media-objects) 
...
[![Bootstrap Rounded Media Objects](../Images/6a5e11e73cd5da107a18a7d4ea27a464.png)](../codelab.php?topic=bootstrap-4&file=rounded-media-objects) 
...
[![Bootstrap Nested Media Objects](../Images/d6e65c2db613addd3b9a7ee962b5a026.png)](../codelab.php?topic=bootstrap-4&file=nested-media-objects) 
...
[![Bootstrap Media Objects Horizontal Alignment](../Images/61541c13d2564926bcd996c088260f59.png)](../codelab.php?topic=bootstrap-4&file=horizontal-alignment-of-media-objects) 
