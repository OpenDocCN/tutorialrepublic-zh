...
[Try this code »](../codelab.php?topic=bootstrap&file=dropdowns-within-navbar "Try this code using online Editor") *```html
...
[Try this code »](../codelab.php?topic=bootstrap&file=dropdowns-within-nav "Try this code using online Editor") *```html
...
[Try this code »](../codelab.php?topic=bootstrap&file=dropup-dropleft-and-dropright-menus "Try this code using online Editor") *```html
<!-- Dropup menu -->
