...
> 原文:[https://www . tutorial Republic . com/Twitter-bootstrap-tutorial/bootstrap-dropdowns . PHP](https://www.tutorialrepublic.com/twitter-bootstrap-tutorial/bootstrap-dropdowns.php)

在本教程中，你将学习如何添加下拉菜单到不同的引导组件。
...
[![Bootstrap Dropdowns within Navbar](../Images/3f5a3a6f2ff9b0c8ee5b0ca5958bac37.png)](../codelab.php?topic=bootstrap&file=dropdowns-within-navbar)  ***提示:**您可以通过在空白的`<div>`元素上添加类`.dropdown-divider`来绘制分隔线来分隔下拉菜单中的链接。*  ** * *
...
[![Bootstrap Dropdowns within Nav](../Images/bb38a29246f9b3835a2e3482f1fd314f.png)](../codelab.php?topic=bootstrap&file=dropdowns-within-nav) 
...
[![Bootstrap Dropdowns within Buttons](../Images/33d4786dc04a34f786f0a57b7e612b5a.png)](../codelab.php?topic=bootstrap&file=dropdowns-within-buttons) 
...
[![Bootstrap Split Button Dropdowns](../Images/d7fd0ced4527b6b83a21a568a00f1ab1.png)](../codelab.php?topic=bootstrap&file=split-button-dropdowns)  ***提示:**你可以在`.btn`元素上使用 Bootstrap 的按钮相对大小调整类，比如`.btn-lg`和`.btn-sm`来进一步[调整按钮下拉列表](../codelab.php?topic=bootstrap&file=sizing-button-dropdowns)的大小。*  ** * *
...
[![Bootstrap Dropdowns within Button Groups](../Images/877d188a5c6b1125f31ee3c696332f67.png)](../codelab.php?topic=bootstrap&file=dropdowns-within-button-groups) 
...
[![Bootstrap Dropup, Dropleft and Dropright Menus](../Images/651daa63e11f3b38818b50445e4d4f45.png)](../codelab.php?topic=bootstrap&file=dropup-dropleft-and-dropright-menus) 
...
[![Bootstrap Right-aligned Dropdown Menus](../Images/f4d8be0b9f504ac9986d8b18a3cc560a.png)](../codelab.php?topic=bootstrap&file=right-aligned-dropdown-menus) 
