...
> 原文:[https://www . tutorial Republic . com/CSS-reference/CSS-background-property . PHP # property-values](https://www.tutorialrepublic.com/css-reference/css-background-property.php#property-values)
