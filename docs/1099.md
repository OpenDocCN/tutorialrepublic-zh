...
[Try this code »](../codelab.php?topic=bootstrap&file=alert-with-icons "Try this code using online Editor") *```html
<!-- Success Alert -->
...
[Try this code »](../codelab.php?topic=bootstrap&file=matching-links-inside-different-alerts "Try this code using online Editor") *```html
<!-- Success Alert -->
<div class="alert alert-success alert-dismissible fade show">
