...
> 原文:[https://www . tutorial Republic . com/Twitter-bootstrap-tutorial/bootstrap-pagination . PHP](https://www.tutorialrepublic.com/twitter-bootstrap-tutorial/bootstrap-pagination.php)
...
[![Bootstrap Pagination](../Images/e449cac7c8f4bcc22ca658403fb148cc.png)](../codelab.php?topic=bootstrap&file=pagination) 
...
[![Bootstrap Pagination with Disabled and Active States](../Images/81e01534b96c15f3be332340c2b7c8a4.png)](../codelab.php?topic=bootstrap&file=pagination-with-disabled-and-active-state)  ***注意:**`.disabled`类只显示禁用的链接，它不删除点击功能，为此你可以用跨度交换活动或禁用的锚点。*  *#### 例子
...
[![Bootstrap Larger and Smaller Pagination](../Images/1adc5dc33a0e3724e94a75b8a2bb268c.png)](../codelab.php?topic=bootstrap&file=pagination-sizes) 
...
[![Bootstrap Pagination Center Alignment](../Images/922b4258fb61672a3eeffacd69313ff6.png)](../codelab.php?topic=bootstrap&file=pagination-center-alignment) 
...
[![Bootstrap Pagination Right Alignment](../Images/2d0c2575ac7eb0b4a962eb9dfa5fbf11.png)](../codelab.php?topic=bootstrap&file=pagination-right-alignment)**