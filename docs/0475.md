...
> 原文:[https://www . tutorial Republic . com/CSS-reference/css3-column-rule-style-property . PHP](https://www.tutorialrepublic.com/css-reference/css3-column-rule-style-property.php)

题目: [CSS3 属性参考](css3-properties.php) [上一个](css3-column-rule-color-property.php) | [下一个](css3-column-rule-width-property.php)

## 描述

CSS 属性设置在多栏布局中的栏之间绘制的规则的样式。
