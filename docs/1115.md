...
在 Bootstrap 中，您可以使用类`.container-fluid`创建流式布局，以利用所有设备尺寸(超小型、小型、中型、大型和超大型)的 100%视口宽度。
...
[Try this code »](../codelab.php?topic=bootstrap-4&file=fluid-layout "Try this code using online Editor") *```html
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
