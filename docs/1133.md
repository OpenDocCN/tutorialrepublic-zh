...
> 原文:[https://www . tutorial Republic . com/Twitter-bootstrap-4-tutorial/bootstrap-pagination . PHP](https://www.tutorialrepublic.com/twitter-bootstrap-4-tutorial/bootstrap-pagination.php)
...
[![Bootstrap Pagination](../Images/7f262b0283682b946672a4f87568a4d8.png)](../codelab.php?topic=bootstrap-4&file=pagination) 
...
[![Bootstrap Pagination with Disabled and Active States](../Images/8732ef47e9cdddccca993d6d3402c551.png)](../codelab.php?topic=bootstrap-4&file=pagination-with-disabled-and-active-state)  ***注意:**`.disabled`类只显示禁用的链接，它不删除点击功能，为此你可以用跨度交换活动或禁用的锚点。*  *#### 例子
...
[![Bootstrap Larger and Smaller Pagination](../Images/2370b4131ad9ea50ed40151dfbad1d59.png)](../codelab.php?topic=bootstrap-4&file=pagination-sizes) 
...
[![Bootstrap Pagination Center Alignment](../Images/3904fb049c0fd9e2a180f308b39ebcae.png)](../codelab.php?topic=bootstrap-4&file=pagination-center-alignment) 
...
[![Bootstrap Pagination Right Alignment](../Images/428395b107819d82caca4a50bb7d8dcc.png)](../codelab.php?topic=bootstrap-4&file=pagination-right-alignment)**