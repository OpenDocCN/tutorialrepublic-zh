...
> 原文:[https://www . tutorial Republic . com/Twitter-bootstrap-4-tutorial/bootstrap-navs . PHP](https://www.tutorialrepublic.com/twitter-bootstrap-4-tutorial/bootstrap-navs.php)

在本教程中，你将学习如何创建引导导航组件。

## 引导导航组件

Bootstrap 提供了一种简单快捷的方式来创建基本的导航组件，如标签和药丸，非常灵活和优雅。所有引导程序的导航组件——标签和药丸——通过基类`.nav`共享相同的基本标记和样式。
...
[![Bootstrap Navigation Menu](../Images/0cd21df4ccc9ee1768de8b844a05f01d.png)](../codelab.php?topic=bootstrap-4&file=nav)  ***注意:**你可以使用类`.disabled`让一个链接看起来像被禁用了。但是，`.disabled`类仅仅通过使链接变灰和移除悬停效果来改变链接的视觉外观，然而链接将保持可点击，除非你[移除`"href"`属性](/faq/how-to-remove-clickable-behavior-from-a-disabled-link-using-jquery.php)。*  ** * *
...
[![Bootstrap Nav Center Alignment](../Images/dfdff7db68ed33993391ce71505de810.png)](../codelab.php?topic=bootstrap-4&file=nav-center-alignment) 
...
[![Bootstrap Nav Right Alignment](../Images/a6e4a5f3b7f4f3f7fcd5cf7b07739910.png)](../codelab.php?topic=bootstrap-4&file=nav-right-alignment) 
...
[![Bootstrap Nav Vertical Alignment](../Images/2b129a893ddaf58104f592448a84be20.png)](../codelab.php?topic=bootstrap-4&file=nav-vertical-alignment) 
...
[![Bootstrap Tabbed Navigation](../Images/ace3527d862452357d1b0286f4a7f394.png)](../codelab.php?topic=bootstrap-4&file=nav-tabs) 
...
[![Bootstrap Tabs with Icons](../Images/6c024005e8c913e1ff40f3f0cf1351e6.png)](../codelab.php?topic=bootstrap-4&file=tabs-with-icons) 
...
[![Bootstrap Pills Navigation](../Images/d9f8881a02a266dcae3a99333a00587b.png)](../codelab.php?topic=bootstrap-4&file=nav-pills) 
...
[![Bootstrap Pills Nav with Icons](../Images/9f65c60eaa637f0870dbc1ba2d3fe047.png)](../codelab.php?topic=bootstrap-4&file=pills-nav-with-icons) 

此外，您可以在`.nav`元素上应用类`.flex-column`,使药丸导航垂直堆叠显示，如下例所示:
...
[![Bootstrap Stacked Pills](../Images/058634437ec92b26d36438e0104ae325.png)](../codelab.php?topic=bootstrap-4&file=stacked-pills) 
...
[![Bootstrap Tabs with Dropdown Menus](../Images/28511b4bfa0815f72397a2b8dd3de98c.png)](../codelab.php?topic=bootstrap-4&file=tabs-with-dropdown-menus) 

### 创建带下拉菜单的药丸

下面的例子将向你展示如何添加简单的下拉菜单到一个药丸导航。
...
[![Bootstrap Pills with Dropdown Menus](../Images/9fbca72cd2432d3282ef2c39d88445fa.png)](../codelab.php?topic=bootstrap-4&file=pills-with-dropdown-menus) 
...
[![Bootstrap Nav Fill](../Images/db6dab766f276dbd6467201b301d50c3.png)](../codelab.php?topic=bootstrap-4&file=nav-fill) 
...
[![Bootstrap Nav Justified](../Images/2e5cbc185fc2315e1bbbb8447c9d9709.png)](../codelab.php?topic=bootstrap-4&file=nav-justified)*