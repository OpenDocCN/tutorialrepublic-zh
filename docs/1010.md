...
> 原文:[https://www . tutorial Republic . com/JavaScript-tutorial/JavaScript-es6-features . PHP](https://www.tutorialrepublic.com/javascript-tutorial/javascript-es6-features.php)
...
在 ES6 之前，JavaScript 中没有对模块的本地支持。JavaScript 应用程序中的所有东西，例如不同 JavaScript 文件中的变量，共享同一个作用域。
