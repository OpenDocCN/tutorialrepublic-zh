...
> 原文:[https://www . tutorial Republic . com/Twitter-bootstrap-4-tutorial/bootstrap-tables . PHP](https://www.tutorialrepublic.com/twitter-bootstrap-4-tutorial/bootstrap-tables.php)
...
[![Bootstrap Simple Table](../Images/c41431dcf2850ab01b1f19182ebc768b.png)](../codelab.php?topic=bootstrap-4&file=simple-table) 
...
[![Bootstrap Dark Table](../Images/ee41127883f2296d677fc902a1af6e8a.png)](../codelab.php?topic=bootstrap-4&file=dark-table)  ***提示:**您可以在`.table`元素中添加一个额外的类`.table-dark`来创建任何表格的暗版本，比如 stripped、hoverable、bordered、compact table 等等。*  ** * *
...
[![Bootstrap Table with Alternate Background](../Images/8cf12a75f49c412e4e3d5f3ed91e57f2.png)](../codelab.php?topic=bootstrap-4&file=table-striped) 
...
[![Bootstrap Dark Table with Alternate Background](../Images/13496bc72f8f0ec109582bc6e44cf34d.png)](../codelab.php?topic=bootstrap-4&file=dark-table-striped) 
...
[![Bootstrap Table with Borders](../Images/bd91e70098fa04a980aa81c6f5ac8981.png)](../codelab.php?topic=bootstrap-4&file=table-bordered) 
...
[![Bootstrap Borderless Table](../Images/a9763225e03ca07d810eb72d214830e2.png)](../codelab.php?topic=bootstrap-4&file=borderless-table) 

* * *

## 在表行上启用悬停状态

您还可以通过将引导程序的类`.table-hover`添加到`.table`基类，在 [`<tbody>`](../html-reference/html-tbody-tag.php) 元素内的表格行上启用悬停状态。这里有一个例子:
...
[![Bootstrap Table with Hover States](../Images/647c1ece046c400dd90a3950d19adb21.png)](../codelab.php?topic=bootstrap-4&file=table-with-hover-states) 
...
[![Bootstrap Compact Table](../Images/ab40098bfb5c63af4fd4082178adbcb6.png)](../codelab.php?topic=bootstrap-4&file=compact-table) 
...
[![Bootstrap Table Head Light](../Images/3d700bec38904388ba1fedf990ae660b.png)](../codelab.php?topic=bootstrap-4&file=table-head-light) 
...
[![Bootstrap Table Head Dark](../Images/367a6f8cc6e143da40083d71d9fca19c.png)](../codelab.php?topic=bootstrap-4&file=table-head-dark) 
...
[![Bootstrap Table with Emphasis Classes](../Images/74d7a53b837bdaba6d053503403744a2.png)](../codelab.php?topic=bootstrap-4&file=table-emphasis-classes) 
