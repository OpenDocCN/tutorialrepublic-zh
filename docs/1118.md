...
[Try this code »](../codelab.php?topic=bootstrap-4&file=simple-table "Try this code using online Editor") *```html
<table class="table">
    <thead>
        <tr>
            <th>Row</th>
...
[Try this code »](../codelab.php?topic=bootstrap-4&file=dark-table "Try this code using online Editor") *```html
...
[Try this code »](../codelab.php?topic=bootstrap-4&file=table-striped "Try this code using online Editor") *```html
...
[Try this code »](../codelab.php?topic=bootstrap-4&file=dark-table-striped "Try this code using online Editor") *```html
...
[Try this code »](../codelab.php?topic=bootstrap-4&file=table-bordered "Try this code using online Editor") *```html
...
[Try this code »](../codelab.php?topic=bootstrap-4&file=borderless-table "Try this code using online Editor") *```html
...
[Try this code »](../codelab.php?topic=bootstrap-4&file=table-with-hover-states "Try this code using online Editor") *```html
...
[Try this code »](../codelab.php?topic=bootstrap-4&file=compact-table "Try this code using online Editor") *```html
...
[Try this code »](../codelab.php?topic=bootstrap-4&file=table-head-light "Try this code using online Editor") *```html
<table class="table">
...
[Try this code »](../codelab.php?topic=bootstrap-4&file=table-head-dark "Try this code using online Editor") *```html
<table class="table">
...
[Try this code »](../codelab.php?topic=bootstrap-4&file=table-emphasis-classes "Try this code using online Editor") *```html
<table class="table">
<thead>
    <tr>
        <th>Row</th>
...
[Try this code »](../codelab.php?topic=bootstrap-4&file=responsive-table "Try this code using online Editor") *```html
