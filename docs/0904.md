...
> 原文:[https://www . tutorial Republic . com/CSS-reference/CSS-outline-property . PHP # property-values](https://www.tutorialrepublic.com/css-reference/css-outline-property.php#property-values)
