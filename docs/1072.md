...
[![Bootstrap List Group](img/617970f13e14e49f6e2804c899eb0e7e.png)](../codelab.php?topic=bootstrap&file=list-group)  ***提示:**列表组默认为 100%宽。要显式设置它们的宽度，你可以使用引导程序的[宽度实用程序类](bootstrap-helper-classes.php#sizing-classes)(例如`w-25`、`w-50`等)。)或将它们放在[网格栏](bootstrap-grid-system.php)内。*  ** * *
...
[![Bootstrap List Group with Linked Items](img/371b067317fb34ef9fc8e181efde1faa.png)](../codelab.php?topic=bootstrap&file=list-group-with-linked-items)  ***提示:**您可以使用引导列表组组件来创建侧边栏导航菜单，例如在您的网站上显示产品或类别列表。*  ** * *
