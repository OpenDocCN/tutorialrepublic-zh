...
[![Bootstrap List Group](img/617970f13e14e49f6e2804c899eb0e7e.png)](../codelab.php?topic=bootstrap&file=list-group)  ***提示:**列表组默认为 100%宽。要显式设置它们的宽度，你可以使用Bootstrap程序的[宽度实用程序类](bootstrap-helper-classes.php#sizing-classes)(例如`w-25`、`w-50`等)。)或将它们放在[网格栏](bootstrap-grid-system.php)内。*  ** * *
...
您将在[Bootstrap定制表单](bootstrap-custom-forms.php)一章中了解定制复选框和单选按钮。

* * *

## 带有链接项目的列表组

您还可以通过 HTML 标记中的微小变化将[列表组项目链接到](../html-tutorial/html-links.php)。
...
[![Bootstrap List Group with Linked Items](img/371b067317fb34ef9fc8e181efde1faa.png)](../codelab.php?topic=bootstrap&file=list-group-with-linked-items)  ***提示:**您可以使用Bootstrap列表组组件来创建侧边栏导航菜单，例如在您的网站上显示产品或类别列表。*  ** * *
...
请查看[Bootstrap标签](bootstrap-tabs.php)章节，了解如何使用Bootstrap列表组组件创建动态垂直标签，而无需使用任何 JavaScript 代码。****