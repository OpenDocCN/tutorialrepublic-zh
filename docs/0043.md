...
> 原文：<https://www.tutorialrepublic.com/html-reference/html5-tags.php>
...
| [T2`<applet>`](html-applet-tag.php) | [过时](../definitions.php#obsolete "Not supported in HTML5")在页面上嵌入 Java 小程序(迷你 Java 应用)。用 [`<object>`](html-object-tag.php) 代替。 |
...
| [`<embed>`](html5-embed-tag.php)T3】 | 将外部应用，通常是音频或视频等多媒体内容嵌入到 HTML 文档中。 |
