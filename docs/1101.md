...
[Try this code »](../codelab.php?topic=bootstrap&file=carousel "Try this code using online Editor") *```html
...
[Try this code »](../codelab.php?topic=bootstrap&file=carousel-with-captions "Try this code using online Editor") *```html
<div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
    <!-- Carousel indicators -->
    <ol class="carousel-indicators">
        <li data-bs-target="#myCarousel" data-bs-slide-to="0" class="active"></li>
...
[Try this code »](../codelab.php?topic=bootstrap&file=carousel-dark "Try this code using online Editor") *```html
